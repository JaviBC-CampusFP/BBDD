...
INSERT INTO Miembro (DNI, Nombre, Apellidos, Cargo, Pertenece_idBanda, Puesto) VALUES
('12345678A','Carlos','Martínez Ruiz','Líder',1,NULL),
('23456789B','Sergio','García López','Segundo',1,1),
('34567890C','María','Hernández Vega','Logística',1,2),
('45678901D','Rafael','Santos Ponce','Líder',2,NULL),
('56789012E','Lucía','Ortega Molina','Exterior',2,1),
('67890123F','Javier','Ruiz Fernández','Líder',3,NULL),
('78901234G','Ana','Córdoba Ruiz','Recluta',3,1),
('89012345H','Miguel','Pérez Díaz','Líder',4,NULL),
('90123456J','David','Alonso Torres','Operativo',4,1),
('01234567K','Sofía','Núñez Castillo','Recluta',4,2);
